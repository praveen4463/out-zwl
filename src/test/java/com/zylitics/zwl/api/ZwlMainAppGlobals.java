...
public class ZwlMainAppGlobals {
  ...
  Map<String, String> get() {
    return new ImmutableMap.Builder<String, String>()
        ...
        .put("BUTTON_DELETE_TREE_ITEM", "button[title='Delete']")
        .put("BUTTON_RENAME_TREE_ITEM", "button[title='Rename']")
        .put("BUTTON_NEW_VERSION_TREE_ITEM", "button[title='Create New Version']")
